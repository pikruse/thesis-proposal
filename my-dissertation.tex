...
\graduationMonth{August}         % month of proposal
...
\usepackage{tikz}                      % chapter 4 architecture and workflow figures
\usetikzlibrary{arrows.meta,backgrounds,calc,fit,positioning,shapes.geometric}
\input{figures/mentor-rl/mentor-rl-style}
...
% \comment{note} is Peter's channel for review notes in the source (blue, small
