...
\nomenclature{\textsc{Mentor}}{Multiplex Embedding of Networks for Team-Based Omics Research}
\nomenclature{\textsc{Mentor-EV}}{\textsc{Mentor} applied with every gene in a multiplex as a seed, yielding a hierarchy over the full gene universe}
\nomenclature{\textsc{Mentor-IA}}{\textsc{Mentor} Interpretation Agent}
\nomenclature{\textsc{Mentor-RL}}{The reinforcement learning-trained mechanistic reasoning model proposed in Chapter~\ref{ch4:mentor-rl}}
